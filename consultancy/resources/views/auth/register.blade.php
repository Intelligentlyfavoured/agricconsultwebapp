      ...
      <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
        <div class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
          ...
          <p class="w-full text-4xl font-medium text-center leading-snug font-serif">Welcome Back</p>
            <p class="w-full text-sm text-center text-gray-500 mt-2">Login to your account</p><br />
            <a href="/login"><p class="w-full text-sm text-center text-gray-500 mt-2 underline">Already have an account? Login here</p></a>
          <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
            <form action="/register" method="POST">
                @csrf
                <div class="relative">
                <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600 absolute">Name</p>
                <input placeholder="Your name" name="name" type="text" class="border placeholder-gray-400 focus:outline-none
                ...
                <input placeholder="hello@example.com" name="email" type="email" class="border placeholder-gray-400 focus:outline-none
                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                    border-gray-300 rounded-md"/>
                </div>
                <div class="relative">
                <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600 absolute">Phone</p>
                <input placeholder="07*****" type="number" name="phone" class="border placeholder-gray-400 focus:outline-none
                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                    border-gray-300 rounded-md"/>
                </div>
                <div class="relative">
