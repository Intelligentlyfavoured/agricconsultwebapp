      ...
      <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
        <div class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
          ...
          <p class="w-full text-4xl font-medium text-center leading-snug font-serif">Welcome Back</p>
            ...
            <a href="/register"><p class="w-full text-sm text-center text-gray-500 mt-2 underline">Don't have an account? Get Started here</p></a>
          <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
            <form action="/login" method="POST">
                @csrf
                <div class="relative">
                  <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600 absolute">Email</p>
                  <input placeholder="user@example.com" name="email" type="email" class="border placeholder-gray-400 focus:outline-none
                ...
                <div class="relative">
                  <input class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500
                      rounded-lg transition duration-200 hover:bg-indigo-600 ease" value="Login" type="submit"/>
                </div>
              </form>
          </div>
        </div>
